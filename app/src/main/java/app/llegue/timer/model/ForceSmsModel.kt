...
object ForceSmsModel : BaseSmsModel() {
    ...
    private const val totalSmsIdsListKey = "app.llegue.timer.model.ForceSmsModel.totalSmsIdsListKey"
    ...
    /**
     * Method is used by [app.llegue.timer.SmsDeliveredReceiver] to notify that another sms
     * has been sent.
     */
